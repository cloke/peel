...
/// Both providers normalize to the same ContentBlock/StreamEvent types.
...
/// Identifies which LLM API backend to use.
public enum ProviderKind: String, CaseIterable, Sendable {
  case copilot   // GitHub Copilot API (OpenAI-compatible) — default
